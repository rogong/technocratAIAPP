...
{
    public partial class ProductsYelpSearch
    {
        public ProductsYelpSearch()
        {
            ProductsYelpReviews = new HashSet<ProductsYelpReview>();
        }
        ...
        public virtual ICollection<ProductsYelpReview> ProductsYelpReviews { get; set; }
    }
}
