...
{
    public partial class ProductsImdbSearch
    {
        public ProductsImdbSearch()
        {
            ProductsImdbReviews = new HashSet<ProductsImdbReview>();
        }
        ...
        public int? NumOfRevies { get; set; }
        ...
        public virtual ICollection<ProductsImdbReview> ProductsImdbReviews { get; set; }
    }
}
